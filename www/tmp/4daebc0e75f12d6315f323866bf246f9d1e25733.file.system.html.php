<?php /* Smarty version Smarty-3.0.6, created on 2012-03-16 11:18:20
         compiled from "D:\freehost\wilee\web/tpl\admin/system.html" */ ?>
<?php /*%%SmartyHeaderCode:75054f62b0fc966724-89662958%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4daebc0e75f12d6315f323866bf246f9d1e25733' => 
    array (
      0 => 'D:\\freehost\\wilee\\web/tpl\\admin/system.html',
      1 => 1331826660,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '75054f62b0fc966724-89662958',
  'function' => 
  array (
  ),
...
">缓存删除</a></h2>
    <h2>站点设置</h2>
    <div>当有新设置可供更新时，请先点一次保存，再设置新的设置并点击保存，就会生效</div>
...
" /></td>
    ...
    <table width="100%" class="table">
      ...
      <tr>
       ...
       <tr>
         <td>宝贝发布</td>
         <td valign="middle"><input name="val[addbaobei_switch]" type="radio"  value="1"  <?php if ($_smarty_tpl->getVariable('conf')->value['addbaobei_switch']==1){?> checked="checked" <?php }?> />
          启用
          <input type="radio" name="val[addbaobei_switch]"  value="0"  <?php if ($_smarty_tpl->getVariable('conf')->value['addbaobei_switch']==0){?> checked="checked" <?php }?> />关闭</td>
       </tr>
...
" /></td>
        <td valign="middle">请将回调地址写成如下形式，将我们的域名换成你的域名:(注意不要粘贴空格)<br />
          http://weiqiushi.com/index.php?c=openconnect&a=qq&callback=true <br/>
...
" /></td>
        <td valign="middle">请将回调地址写成如下形式，将我们的域名换成你的域名:(注意不要粘贴空格)<br />
          http://weiqiushi.com/index.php?c=openconnect&a=weibo&callback=true </td>
      </tr>
    </table>
